...
class Transformer_Based_Model(nn.Module):
    def __init__(self, dataset, temp, D_text, D_visual, D_audio, n_head,
        ...
        self.textf_input = CausalConv1d(D_text, hidden_dim, kernel_size=1, bias=False)
        self.acouf_input = CausalConv1d(D_audio, hidden_dim, kernel_size=1,  bias=False)
        self.visuf_input = CausalConv1d(D_visual, hidden_dim, kernel_size=1,  bias=False)
